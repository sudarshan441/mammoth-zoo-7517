      ...
      function appendata1(data1,start1,end1){
      ...
      for(let i=start1; i<end1; i++){
        ...
        para.innerText=data1[i].para;
        let by=document.createElement("p");
        by.innerText=data1[i].by;
  ...
  let butons=document.querySelectorAll("#btn>button");
  
  butons.forEach(function(tab,index){
   tab.addEventListener("click",function(){
    butons.forEach(function tab(){
           tab.classList.remove("active")
       })
       butons[index].classList.add("active")
   })
      ...
      function appendata(data2,start2,end2){
      ...
      for(let i=start2; i<end2; i++){
        ...
        img1.src=data2[i].img;
        
        let title1=document.createElement("h4");
        title1.innerText=data2[i].title;
        let para1=document.createElement("p");
        para1.innerText=data2[i].para;
        let by1=document.createElement("p");
        by1.innerText=data2[i].by;
      
      
        div1.append(img1,title1,para1,by1)
      document.getElementById("box3").append(div1);
       ...
       document.querySelector("#appa").addEventListener("click",function(){
        appendata(arr3,6,9);
       })
       document.querySelector("#jewel").addEventListener("click",function(){
        appendata(arr3,9,12);
       })
       document.querySelector("#foot").addEventListener("click",function(){
        appendata(arr3,12,15);
       })
       document.querySelector("#pet").addEventListener("click",function(){
        appendata(arr3,15,18);
       })
       document.querySelector("#child").addEventListener("click",function(){
        appendata(arr3,18,21);
       })
       document.querySelector("#ready").addEventListener("click",function(){
        appendata(arr3,21,24);
       })
       
      
       let tab=document.querySelectorAll("#btn3>button")
